...
// Destructor implementation - required for proper cleanup of unique_ptr<Trait>
EffectComponent::PrimaryEffect::~PrimaryEffect() = default;

// Move constructor implementation
EffectComponent::PrimaryEffect::PrimaryEffect(PrimaryEffect&& other) noexcept
    : type(other.type), subType(std::move(other.subType)), genericType(other.genericType),
      secondGenericType(other.secondGenericType), statusType(std::move(other.statusType)),
      traitType(std::move(other.traitType)), primaryValue(std::move(other.primaryValue)),
      secondaryValue(std::move(other.secondaryValue)), extras(std::move(other.extras))
{
}

// Move assignment operator implementation
EffectComponent::PrimaryEffect&
EffectComponent::PrimaryEffect::operator=(PrimaryEffect&& other) noexcept
{
    if (this != &other)
    {
        type = other.type;
        ...
        secondGenericType = other.secondGenericType;
        statusType = std::move(other.statusType);
        traitType = std::move(other.traitType);
        primaryValue = std::move(other.primaryValue);
        secondaryValue = std::move(other.secondaryValue);
